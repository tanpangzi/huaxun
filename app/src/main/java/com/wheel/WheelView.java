...
public class WheelView extends View {
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(getResources().getColor(R.color.bar_botoom_text));
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(getResources().getColor(R.color.bar_botoom_text));
