...
import cn.huaxunchina.cloud.app.tools.GetColor;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private Paint dividerPaint; // 间隔线
	private int indicatorColor = GetColor.indicatorColor;// 0xFF666666; 下横线
	...
	private int tabTextColor = Color.parseColor("#8e8e93");// 0xFF666666;
															// tab默认字体颜色
	private int selectedTabTextColor = Color.parseColor("#000000");// 0xFF666666;
	...
	public void setCilck(boolean isCilck) {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (isCilck) {
				tab_txt.setClickable(true);
			} else {
				tab_txt.setClickable(false);
			}
		}
	}
	...
	private void addTextTab(final int position, String title) {
		...
		// tab.setLayoutParams(new LayoutParams(400,LayoutParams.WRAP_CONTENT));
		tab.setText(title);
