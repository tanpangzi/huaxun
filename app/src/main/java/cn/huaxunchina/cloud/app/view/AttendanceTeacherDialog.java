...
public class AttendanceTeacherDialog extends Dialog {
	...
	public AttendanceTeacherDialog(Context context,List<ClassInfo> classInfo,int width,int height,boolean isClass) {
		super(context,theme);
	...
	public AttendanceTeacherDialog(Context context, int theme) {
		super(context, theme);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.att_inquiry_btn).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(isClass){
				attendanceTeacherCallBack.onSelectdata(null,curYear+"-"+month_adapter.getValues()+"-"+day_adapter.getValues());
				}else{
				//String classId = classdata_map.get(class_adapter.getValues());   
				String classId = class_id.get(class_adapter.getIndexs());
				attendanceTeacherCallBack.onSelectdata(classId, curYear+"-"+month_adapter.getValues()+"-"+day_adapter.getValues());
				}
				dismiss();
	...
	public void setAttendanceTeacherCallBack(AttendanceTeacherCallBack callBack){
