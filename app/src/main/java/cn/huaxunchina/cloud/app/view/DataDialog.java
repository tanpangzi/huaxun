...
public class DataDialog extends Dialog {
	...
	public DataDialog(Context context, boolean flag) {
		super(context, R.style.Theme_AppCompat_Dialog);
		this.mContext = context;
	}

	public DataDialog(Context context, Calendar instance) {
		this(context);
		calendar = instance;
	}
	...
	private void adjustView() {
		// 根据屏幕密度来指定选择器字体的大小
		int textSize = 0;
//		textSize = pixelsToDip(mContext.getResources(), 5);
		textSize = (int) mContext.getResources().getDimension(R.dimen.dialog_text_size);
	...
	public DataDialog setDate(Calendar calendar) {
		if (calendar == null)
			return this;
	...
	public static class Builder {
		...
		public DataDialog create() {
			final DataDialog dialog = new DataDialog(P.mContext);
			P.apply(dialog);
	...
	public static class DatePickParams {
		...
		public void apply(DataDialog dialog) {
			if (mTitle != null) {
