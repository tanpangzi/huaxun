 ...
 * 
 */
public class AddFenceNoticeTypeDialog extends Dialog {

	private AddFenceTypeCallBack callBack;
	...
	public AddFenceNoticeTypeDialog(Context context, int width, int height,
			String[] typedata) {
		super(context, theme);
		this.width = width;
		this.height = height;
	...
	public AddFenceNoticeTypeDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public void AddFenceTypeCallBack(AddFenceTypeCallBack callBack) {
		this.callBack = callBack;
	}

	public interface AddFenceTypeCallBack {
		/**
